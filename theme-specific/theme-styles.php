...
if (!function_exists('smart_casa_customizer_get_css')) {

	function smart_casa_customizer_get_css($args=array()) {
		...
		if ($fonts) {
			...
			$fonts = smart_casa_customizer_add_theme_fonts($fonts);
...
.smart_casa_tabs .smart_casa_tabs_titles li a {
...
div.ui-widget .sc_form_field_button button,
...
CSS;
			$rez = apply_filters('smart_casa_filter_get_css', $rez, array('fonts' => $fonts));
			$css['fonts'] = $rez['fonts'];
		}
		...
		if ($vars) {
			...
			// Make theme-specific fonts rules
			$vars = smart_casa_customizer_add_theme_vars($vars);
			extract($vars);
...
CSS;
			$rez = apply_filters('smart_casa_filter_get_css', $rez, array('vars' => $vars));
			$css['vars'] = $rez['vars'];
		}
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($scheme) ? array_keys(smart_casa_get_sorted_schemes()) : array($scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $s) {
					// Prepare colors
					if (empty($scheme)) $colors = smart_casa_get_scheme_colors($s);
...
table tr:not(:nth-child(2n)) th a {
	color: {$colors['extra_dark']} !important;
}
table tr:not(:nth-child(2n)) th a:hover {
...
table th a:hover, table > tbody th a:hover {
...
.wp-block-search button.wp-block-search__button.has-icon:hover:before {
...
.woocommerce-form-login label.woocommerce-form-login__rememberme > input[type="checkbox"] + span:before,
...
.wpcf7 .extra_button_color input[type="submit"] {
 	color: {$colors['inverse_link']};
	background-color: {$colors['text_link3']};
}
...
.sc_layouts_cart_widget .widget_shopping_cart .woocommerce-mini-cart__buttons.buttons .button:hover {
    color: {$colors['text_hover']};
	background-color: transparent;
}
...
.sc_layouts_cart_widget .widget_shopping_cart .woocommerce-mini-cart__buttons.buttons .button.checkout:hover {
    color: {$colors['inverse_link']};
...
.wpcf7 .extra_button_color input[type="submit"]:hover {
    color: {$colors['inverse_link']};
	background-color: {$colors['text_link3_blend']};
}
.wpcf7 .popup_form input[type="submit"]:hover {
    color: {$colors['inverse_link']};
	background-color: {$colors['text_link3_blend']};
}
...
/* Apple & Google Button */
.sc_button.apple_button:hover {
    color: {$colors['inverse_link']} !important;
	background-color: {$colors['text_link3_blend']} !important;
}
.sc_button.google_button:hover {
    color: {$colors['inverse_link']} !important;
	background-color: {$colors['alter_hover_blend']} !important;    
}
...
.sc_layouts_row_type_narrow .sc_layouts_item  .sc_layouts_iconed_text a:not(.sc_button):not(.button) .sc_layouts_item_icon,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item  .sc_layouts_iconed_text a:not(.sc_button):not(.button) .sc_layouts_item_icon {
    color: {$colors['alter_text']};
}
...
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item  .sc_layouts_iconed_text a:not(.sc_button):not(.button) .sc_layouts_item_details .sc_layouts_item_details_line1 {
    color: {$colors['alter_text']};
}

.sc_layouts_row_type_narrow .sc_layouts_item .sc_layouts_iconed_text a:not(.sc_button):not(.button):hover .sc_layouts_item_icon,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item  .sc_layouts_iconed_text a:not(.sc_button):not(.button):hover .sc_layouts_item_icon {
    color: {$colors['alter_link']};
}
.sc_layouts_row_type_narrow .sc_layouts_item  .sc_layouts_iconed_text a:not(.sc_button):not(.button):hover .sc_layouts_item_details .sc_layouts_item_details_line1,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item  .sc_layouts_iconed_text a:not(.sc_button):not(.button):hover .sc_layouts_item_details .sc_layouts_item_details_line1  {
    color: {$colors['alter_dark']};
}
.sc_layouts_row_type_narrow .sc_layouts_item + .sc_layouts_item .sc_layouts_iconed_text:before,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item + .sc_layouts_item .sc_layouts_iconed_text:before {
...
.sc_layouts_row_type_normal .sc_layouts_item span.author_by,
...
.sc_layouts_menu_nav > li > ul:before {
    border-bottom-color: {$colors['extra_link']};
}
...
.smart_casa_tabs .smart_casa_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.smart_casa_tabs .smart_casa_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.sheme_self.sidebar .smart_casa_tabs .smart_casa_tabs_titles li a {
	color: {$colors['alter_dark']};
	background-color: {$colors['alter_bg_hover']};
}
.sheme_self.sidebar div.esg-filter-wrapper .esg-filterbutton > span:hover,
.sheme_self.sidebar .mptt-navigation-tabs li a:hover,
.sheme_self.sidebar .smart_casa_tabs .smart_casa_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_link']};
}
...
.sheme_self.sidebar .smart_casa_tabs .smart_casa_tabs_titles li.ui-state-active a {
...
.esgbox-toolbar button.esgbox-button {
    background-color: {$colors['text_link3']} !important; 
}

.esgbox-toolbar button.esgbox-button:hover {
    background-color: {$colors['text_link3_blend']} !important; 
}
...
/* Post Layouts Excerpt
------------------------------------------ */

.post_layout_excerpt .post_meta_wrapper .post_meta_left .post_meta_item.post_categories,
...
.post_layout_excerpt .post_meta_wrapper .post_meta_left .post_meta_item.post_categories a:hover {
	color: {$colors['inverse_hover']};
    background-color: {$colors['text_hover']};
}
...
.post_layout_excerpt .post_content .post_meta_item.post_tags a:hover {
    color: {$colors['text_link']};
}
...
.mejs-controls .mejs-horizontal-volume-slider .mejs-horizontal-volume-total {
	background: {$colors['inverse_hover_02']};
}
...
.post_item_single .post_meta_wrapper .post_meta_left .post_meta_item.post_categories,
...
.post_item_single .post_meta_wrapper .post_meta_left .post_meta_item.post_categories a:hover {
	color: {$colors['inverse_hover']};
    background-color: {$colors['text_hover']};
}
...
.scheme_self.author_info .author_title:hover {
	color: {$colors['text_hover']};
}
...
.scheme_self.sidebar .widget.widget_block h2  {
    border-color: {$colors['alter_bd_hover']};
}
...
.scheme_self.sidebar .post_info .post_info_item .post_info_date {
    color: {$colors['alter_link']};
}
...
.scheme_self.sidebar .widget_area .post_item + .post_item,
.scheme_self.sidebar aside .post_item + .post_item {
    border-color: {$colors['alter_bd_color']};
}
...
.scheme_self.sidebar .widget_calendar .wp-calendar-nav a:focus,
...
/* Recent comments */
.scheme_self.sidebar .widget_recent_comments ul > li + li {
    border-color: {$colors['alter_bd_color']};
}
...
/* Widget Nav */
.scheme_self.footer_wrap .widget_nav_menu ul > li a,
footer_wrap .widget_nav_menu ul > li a {
    color: {$colors['alter_text']};
}
.scheme_self.footer_wrap .widget_nav_menu ul > li a:hover,
...
rs-module-wrap .custom-smart-casa.tparrows:hover { 
     color: {$colors['inverse_link']};
     background-color: {$colors['text_link']};
}
...
rs-module-wrap .custom-smart-casa .tp-bullet:hover,
rs-module-wrap .custom-smart-casa .tp-bullet.selected {
      background-color: {$colors['inverse_link']};
}


/* Custom Section */
.custom_section .custom_section_container .socials_wrap .social_item .social_icon {
  	color: {$colors['inverse_link']};
    background-color: {$colors['alter_hover']};
}
...
CSS;
					...
					$rez = apply_filters('smart_casa_filter_get_css', $rez, array('colors' => $colors, 'scheme' => $s));
		...
		return apply_filters( 'smart_casa_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>