...
// Search page setup
// (uncomment lines with smart_casa_storage_set_array2() calls if you want to override the relevant settings from Theme Options)
...
smart_casa_storage_set_array2('options', 'blog_style', 'val', 'masonry_3');

// Sidebar position:
// Replace last parameter with one of values: none | left | right
smart_casa_storage_set_array2('options', 'sidebar_position_blog', 'val', 'none');
