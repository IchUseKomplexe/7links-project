...
?><div id="post-<?php the_ID(); ?>"
    <?php post_class( 'related_item related_item_style_2 post_format_'.esc_attr($smart_casa_post_format) ); ?>><?php
    smart_casa_show_post_featured(array(
            'thumb_size' => apply_filters('smart_casa_filter_related_thumb_size', smart_casa_get_thumb_size( (int) smart_casa_get_theme_option('related_posts') == 1 ? 'huge' : 'big' )),
    ...
    ?><div class="post_header entry-header"><?php
        ...
        ?>
        <h6 class="post_title entry-title"><a href="<?php echo esc_url($smart_casa_link); ?>"><?php the_title(); ?></a></h6>
    </div>
</div>