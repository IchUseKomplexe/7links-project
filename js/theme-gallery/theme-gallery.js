...
;(function(window) {
	...
	GalleryFx.prototype._init = function() {
		...
		smart_casa_when_images_loaded( jQuery(this.galleryEl), function() {
			// init/bind events
			self._initEvents();
	...
	jQuery(document).on('action.init_hidden_elements', function(e, cont) {
		...
		cont.find('.portfolio_wrap,.masonry_wrap,.post_format_gallery .gallery').each(function() {
			...
			if (!portfolio.hasClass('inited')) {
				...
				smart_casa_when_images_loaded( portfolio, function() {
					// item selector
		...
		cont.find('.gallery_wrap:not(.inited)').each(function(idx) {
			...
			if (!SMART_CASA_STORAGE['GalleryFx']) SMART_CASA_STORAGE['GalleryFx'] = {};
			...
			SMART_CASA_STORAGE['GalleryFx'][id] = new GalleryFx(this, {
