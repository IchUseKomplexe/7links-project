...
if ( !function_exists( 'smart_casa_trx_addons_add_theme_vars' ) ) {
	add_filter( 'smart_casa_filter_add_theme_vars', 'smart_casa_trx_addons_add_theme_vars', 10, 2 );
	function smart_casa_trx_addons_add_theme_vars($rez, $vars) {
...
if (!function_exists('smart_casa_trx_addons_get_css')) {
	add_filter('smart_casa_filter_get_css', 'smart_casa_trx_addons_get_css', 10, 2);
	function smart_casa_trx_addons_get_css($css, $args) {
...
.sc_services_tabs .sc_services_item_label,
.sc_promo_modern .sc_promo_link2 {
	{$fonts['button_font-family']}
}
.trx_addons_message_box,
.sc_price_item_subtitle,
.sc_blogger_default .post_meta .post_meta_item.post_date,
...
.slider_outer_controls_outside .slider_controls_wrap > a {
	color: {$colors['inverse_link']};
	background-color: {$colors['inverse_link_015']};
	border-color: {$colors['inverse_link_015']};
}

/*Elastic Slider Controls*/

.slider_outer_controls_top.slider_elastistack_outer .slider_controls_wrap > a,
.slider_outer_controls_outside.slider_elastistack_outer .slider_controls_wrap > a,
.slider_outer_controls_bottom.slider_elastistack_outer .slider_controls_wrap > a,
.slider_container.slider_controls_side.slider_elastistack_outer .slider_controls_wrap > a,
.slider_outer_controls_side.slider_elastistack_outer .slider_controls_wrap > a {
    color: {$colors['text_hover']} !important;
    background-color: {$colors['text_link2']} !important;
    border-color: {$colors['text_link2']} !important; 
}
.slider_outer_controls_top.slider_elastistack_outer .slider_controls_wrap > a:hover,
.slider_outer_controls_outside.slider_elastistack_outer .slider_controls_wrap > a:hover,
.slider_outer_controls_bottom.slider_elastistack_outer .slider_controls_wrap > a:hover,
.slider_container.slider_controls_side.slider_elastistack_outer .slider_controls_wrap > a:hover,
.slider_outer_controls_side.slider_elastistack_outer .slider_controls_wrap > a:hover {
    color: {$colors['inverse_hover']} !important;
...
.swiper-pagination-custom .swiper-pagination-button {
	...
	background-color: {$colors['alter_link_03']};
}
...
.widget_contacts .contacts_info span.contacts_email a:hover {
...
.sidebar .widget_contacts .contacts_info a.contacts_phone:before {
   color: {$colors['extra_link3']}!important;
}
.widget_contacts .contacts_info a.contacts_phone:hover {
...
.extra_color .widget_contacts span.contacts_email a:hover {
    color: {$colors['extra_hover']};
} 

.extra_color .widget_contacts .contacts_info a.contacts_phone {
    color: {$colors['extra_hover']};
}
.extra_color .widget_contacts .contacts_info a.contacts_phone:hover {
    color: {$colors['text_dark']};
}
...
.sc_title_default.color_style_dark .sc_item_subtitle {
    color:{$colors['text_dark']};
}
...
.sc_blogger_default .post_featured .post_info .post_title a {
    color: {$colors['inverse_link']};
}
.sc_blogger_default .post_featured .post_info .post_title a:hover {
    color: {$colors['text_hover']};
}
.sc_blogger_default .post_featured .post_info .post_date,
.sc_blogger_default .post_featured .post_info .post_date a {
     color: {$colors['text_hover']};
}
.sc_blogger_default .post_featured .post_info .post_date a:hover {
     color: {$colors['inverse_link']};
} 
...
.sc_icons_extra .sc_icons_item {
    background-color: {$colors['bg_color']};
    -webkit-box-shadow: 0 4px 27px {$colors['text_dark_01']};
	-moz-box-shadow: 0 4px 27px {$colors['text_dark_01']};
	box-shadow: 0 4px 27px {$colors['text_dark_01']};
}
.sc_icons_extra .sc_icons_item:hover {
    -webkit-box-shadow: 0 4px 27px {$colors['text_dark_015']};
	-moz-box-shadow: 0 4px 27px {$colors['text_dark_015']};
	box-shadow: 0 4px 27px {$colors['text_dark_015']};
}

.sc_icons_alter .sc_icons_icon {
	color: {$colors['inverse_link']};
    background-color: {$colors['text_hover_015']};
}
...
.sc_icons_alter  .sc_icons_item_linked:hover .sc_icons_icon {
    color: {$colors['text_hover']};
}
...
.sc_price_item {
    ...
    -webkit-box-shadow: 0px 5px 70px {$colors['text_dark_01']};
    -moz-box-shadow: 0px 5px 70px {$colors['text_dark_01']};
    box-shadow: 0px 5px 70px {$colors['text_dark_01']};
}
.sc_price_item:hover {
	background-color: {$colors['bg_color']};
	border-color: {$colors['bg_color']};
        -webkit-box-shadow: 0px 5px 70px {$colors['text_dark_015']};
    -moz-box-shadow: 0px 5px 70px {$colors['text_dark_015']};
    box-shadow: 0px 5px 70px {$colors['text_dark_015']};
}
...
/* Services */
.services_page_tabs.trx_addons_tabs .trx_addons_tabs_titles li.ui-state-active > a:hover {
    color: {$colors['text_hover']};
}
...
.sc_services .sc_services_item_button.sc_item_button a {
    color: {$colors['text_hover2']} !important;
	background-color: {$colors['text_link2']} !important;
}
.sc_services .sc_services_item_button.sc_item_button a:hover {
    color: {$colors['inverse_hover']} !important;
	background-color: {$colors['text_hover2']} !important;
}
.sc_services_tabs .sc_services_item_button.sc_item_button a {
   	color: {$colors['inverse_link']} !important;
	background-color: {$colors['text_link3']} !important;
}
.sc_services_tabs .sc_services_item_button.sc_item_button a:hover {
   	color: {$colors['inverse_link']} !important;
...
.sc_services_tabs .sc_services_tabs_list_item + .sc_services_tabs_list_item {
     border-color: {$colors['extra_dark_015']};
}
...
.sc_services_tabs  .sc_services_item_subtitle a {
    color:{$colors['alter_light']} !important;
}
.sc_services_tabs  .sc_services_item_subtitle a:hover {
...
.sc_services_tabs .sc_services_tabs_list_item .sc_services_item_number {
    background-color:{$colors['inverse_hover_015']};
    border-color: transparent;
...
.sc_testimonials.sc_testimonials_extra .sc_item_subtitle,
.scheme_self.sc_testimonials.sc_testimonials_extra .sc_item_subtitle {
    color: {$colors['extra_link']};
}
...
.scheme_self.sc_testimonials.sc_testimonials_alter:before {
     color: {$colors['alter_link_01']};
}

.sc_testimonials.sc_testimonials_extra:before,
.scheme_self.sc_testimonials.sc_testimonials_extra:before {
    color: {$colors['alter_link_02']};
}
.sc_testimonials_item_content:before{
    color: {$colors['alter_link_02']};
}
...
.scheme_self.sc_team_extra .sc_team_item {
    background-color: {$colors['alter_bg_color']};
}
.sc_team_extra .sc_team_item .sc_team_item_title a,
.scheme_self.sc_team_extra .sc_team_item .sc_team_item_title a {
   color: {$colors['text_dark']};
}
.sc_team_extra .sc_team_item .sc_team_item_title a:hover,
.scheme_self.sc_team_extra .sc_team_item .sc_team_item_title a:hover {
   color: {$colors['text_link']};
}
.sc_team_extra .sc_team_item  .sc_team_item_subtitle,
.scheme_self.sc_team_extra .sc_team_item  .sc_team_item_subtitle {
   color: {$colors['text_dark']};
}
.sc_team_extra .sc_team_item  .sc_team_item_content,
.scheme_self.sc_team_extra .sc_team_item  .sc_team_item_content {
   color: {$colors['text_dark']};
}
.sc_team_extra .sc_team_item .socials_wrap .social_item .social_icon,
.scheme_self.sc_team_extra .sc_team_item .socials_wrap .social_item .social_icon {
   color: {$colors['inverse_link']};
   background-color: {$colors['inverse_link_015']};
}
...
.sc_team_extra .sc_team_item .socials_wrap .social_item .social_icon:hover,
.scheme_self.sc_team_extra .sc_team_item .socials_wrap .social_item .social_icon:hover {
   color: {$colors['inverse_link']};
   background-color: {$colors['text_hover2']};
}
...
.trx_addons_cv .trx_addons_scroll_to_top:hover {
	color: {$colors['inverse_link']};
	border-color: {$colors['alter_hover_blend']};
	background-color: {$colors['alter_hover_blend']};
}
.trx_addons_scroll_to_top > span {
    color: {$colors['text']};
}
...
.trx_addons_popup, .scheme_self.trx_addons_popup {
	...
	border-color: {$colors['bd_color']};
	color: {$colors['text']};
    -webkit-box-shadow: 0 27px 43px {$colors['inverse_link_03']};
    -moz-box-shadow: 0 27px 43px {$colors['inverse_link_03']};
    box-shadow: 0 27px 43px {$colors['inverse_link_03']};
}

.trx_addons_popup button.mfp-close:after {
    color: {$colors['text_dark']};
}
...
/*Mobile Menu*/
.sc_layouts_menu_mobile_button .sc_layouts_item_link .sc_layouts_item_icon.trx_addons_icon-menu {
    color: {$colors['text_link']};
}
.sc_layouts_menu_mobile_button .sc_layouts_item_link:hover .sc_layouts_item_icon.trx_addons_icon-menu {
    color: {$colors['text_hover']};
}
...
.sc_layouts_row_type_compact .sc_layouts_login_menu .menu-item:not(.menu-item-has-children) .trx_addons_login_link:hover .sc_layouts_item_details_line1 {
    color: {$colors['inverse_link']};
    background-color: {$colors['text_hover2']};
}
